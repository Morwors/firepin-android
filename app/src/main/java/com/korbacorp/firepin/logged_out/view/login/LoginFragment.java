package com.korbacorp.firepin.logged_out.view.login;
...
import com.korbacorp.firepin.logged_out.view.register.RegisterFragment;
...
public class LoginFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        textRegister = view.findViewById(R.id.textLoginRegister);
        textRegister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.frame_layout_logged_out_container, new RegisterFragment());
                transaction.commit();
            }
        });
    }
    ...
    public void login(final String email, final String password) {
        ...
        final String url = "http://192.168.0.17:3000/login.api";
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response) {
                        ...
                        SharedPref.setStringPreference(getActivity(), "USER", user.toString());
                        Intent loggedInIntent = new Intent(getActivity(), LoggedInActivity.class);
                        getActivity().startActivity(loggedInIntent);
                        getActivity().finish();
